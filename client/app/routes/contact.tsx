...
export default function ContactPage(){
    ...
    <main className="md:max-w-[800px] mx-auto p-5 space-y-2" >
        ...
        <form className="flex flex-col space-y-5 children-padding">
            <input className="bg-slate-200 outline-none border-2" type="text" placeholder="Type your email*" />
            <input className="bg-slate-200 outline-none border-2"  type="text" placeholder="Type your name"/>
            <input className="bg-slate-200 outline-none border-2"  type="text" placeholder="Type your Phone Number" />
            <textarea className="bg-slate-200 outline-none border-2"  placeholder="Comment"></textarea>
